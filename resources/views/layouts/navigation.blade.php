        ...
        <li class="sidebar-item">
            ...
            <ul id="items" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar" style="">
                <li class="sidebar-item"><a class="sidebar-link" href=""><i class="align-middle"
                            data-lucide="list"></i> Categories</a></li>
                <li class="sidebar-item"><a class="sidebar-link" href=""><i class="align-middle"
                            data-lucide="list"></i> Items</a></li>
            </ul>
        </li>
        <li class="sidebar-item">
    ...
    @if (Auth::user()->role === 'bac')
        ...
        <li class="sidebar-item">
            ...
            <ul id="items" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar"
                style="">
                <li class="sidebar-item"><a class="sidebar-link" href=""><i class="align-middle"
                            data-lucide="file-input"></i> Requested Items</a></li>
                <li class="sidebar-item"><a class="sidebar-link" href=""><i class="align-middle"
                            data-lucide="package"></i> Items</a></li>
                <li class="sidebar-item"><a class="sidebar-link" href=""><i class="align-middle"
                            data-lucide="package"></i> Item Categories</a></li>
            </ul>
        </li>
        <li class="sidebar-item">
            <a data-bs-target="#purchasing" data-bs-toggle="collapse" class="sidebar-link collapsed"
    ...
    @if (Auth::user()->role === 'budget')
        ...
        <li class="sidebar-item">
            <a data-bs-target="#budgeting" data-bs-toggle="collapse" class="sidebar-link collapsed"
                aria-expanded="false">
                <i class="align-middle" data-lucide="coins"></i> <span class="align-middle">Budgeting</span>
            </a>
            <ul id="budgeting" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar"
                style="">
                <li class="sidebar-item"><a class="sidebar-link" href=""><i class="align-middle"
                            data-lucide="banknote"></i> Whole Budget</a></li>
                <li class="sidebar-item"><a class="sidebar-link" href=""><i class="align-middle"
        ...
        <li class="sidebar-item">
            ...
            <ul id="purchasing" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar"
                ...
                <li class="sidebar-item"><a class="sidebar-link" href=""><i class="align-middle"
                            data-lucide="file"></i> PPMP</a></li>
                <li class="sidebar-item"><a class="sidebar-link" href=""><i class="align-middle"
                            data-lucide="file"></i> Purchase Requests</a></li>
                <li class="sidebar-item"><a class="sidebar-link" href=""><i class="align-middle"
                            data-lucide="file"></i> Purchase Order</a></li>
